...
(defcustom template-default-directories
  (cons (if (and (not (file-directory-p "~/.emacs.d/lib/template/template-3.3b/templates/"))
		 (file-directory-p "~/lib/templates"))
	    (expand-file-name "~/lib/templates/")
	  (expand-file-name "~/.emacs.d/lib/template/template-3.3b/templates/"))
...
non-nil, return nil instead (FULL \. \"~/.emacs.d/lib/template/template-3.3b/templates/DEFAULT.tpl\") if no
